...
/** name me. */
public class NotRecursiveRoutine extends Command {
   ...
   */
  public NotRecursiveRoutine(IntakeSubsystem intakeSubsystem, double power, VisionSubsystem vision, LEDSubsystem ledSubsystem) {
