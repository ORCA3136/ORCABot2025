...
//   ---
  ...
  private double elevatorSetpoint = 10;
...
ElevatorFeedforward m_feedforward =
  ...
  public void setSimMotorPower(double power) {
    m_motor.set(power);
  }
  ...
  public void simulationPeriodic() {
    ...
    updateTelemetry();
    SmartDashboard.putData("Elevator mechanism", m_mech2d);
  }
}